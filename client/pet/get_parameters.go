...
// WithPetID adds the petID to the get params
func (o *GetParams) WithPetID(petID int64) *GetParams {
	o.SetPetID(petID)
	return o
}

// SetPetID adds the petId to the get params
func (o *GetParams) SetPetID(petID int64) {
	o.PetID = petID
}
