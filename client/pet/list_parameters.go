...
// WithKind adds the kind to the list params
func (o *ListParams) WithKind(kind *string) *ListParams {
	o.SetKind(kind)
	return o
}

// SetKind adds the kind to the list params
func (o *ListParams) SetKind(kind *string) {
	o.Kind = kind
}
