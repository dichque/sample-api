...
// WithPet adds the pet to the create params
func (o *CreateParams) WithPet(pet *models.Pet) *CreateParams {
	o.SetPet(pet)
	return o
}

// SetPet adds the pet to the create params
func (o *CreateParams) SetPet(pet *models.Pet) {
	o.Pet = pet
}
