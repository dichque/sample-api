...
func (o *GetOK) Error() string {
	return fmt.Sprintf("[GET /pets/{petId}][%d] getOK  %+v", 200, o.Payload)
}
...
func (o *GetBadRequest) Error() string {
	return fmt.Sprintf("[GET /pets/{petId}][%d] getBadRequest ", 400)
}
...
func (o *GetNotFound) Error() string {
	return fmt.Sprintf("[GET /pets/{petId}][%d] getNotFound ", 404)
}
